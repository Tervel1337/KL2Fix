...
void Misc::Install() {
	...
	if (GetPrivateProfileIntA("KL2Fix", "UncapLoadScreen", 0, ConfigPath) == 1) Patch<char>(0x0053AD94, 0);

    if (GetPrivateProfileIntA("KL2Fix", "MultiInstance", 0, ConfigPath) == 1) Patch<char>(0x0047691C, 0xEB);
}